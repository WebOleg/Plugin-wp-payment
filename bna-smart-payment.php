...
class BNA_Smart_Payment {
    ...
    public function init() {
        ...
        BNA_Logger::info('BNA Smart Payment plugin loaded', ['version' => BNA_SMART_PAYMENT_VERSION]);
    }
    ...
    public function activate() {
        ...
        flush_rewrite_rules();
        BNA_Logger::enable(); // Enable logging on activation
    }
